...
public class ConstantGroupTest {
	@Test
	public void subgroup() {
		String[] strings = {"my abc", "my def", "my ghi", "abc", "def", "ghi"};
		ConstantGroup<String> constants = new ConstantGroup<>(strings);
		ConstantGroup<String> my = constants.subGroup("my", s -> s.startsWith("my"));
		ConstantGroup<String> abc = constants.subGroup("abc", s -> s.contains("abc"));
		...
		ConstantGroup<String> myAgain = constants.subGroup("my", s -> false);
		ConstantGroup<String> abcAgain = constants.subGroup("abc", s -> false);
